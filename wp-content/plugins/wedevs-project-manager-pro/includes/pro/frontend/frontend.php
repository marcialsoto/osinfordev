...
class CPM_Frontend {
    ...
    function my_task($atts) {
        ...
        require_once self::$parent_path  . '/views/task/my-task.php';
        return ob_get_clean();
    }
    ...
    function calender( $atts ) {
        ...
        extract( shortcode_atts( array('id' => 0), $atts ) );
        ob_start();
        require_once self::$parent_path  . '/views/calendar/index.php';
        return ob_get_clean();
    }
    ...
    function includes() {
        ...
        if ( ! is_admin() ) {
            ...
            //require_once self::$parent_path  . '/includes/functions.php';
            //require_once self::$parent_path  . '/includes/urls.php';
            //require_once self::$parent_path  . '/includes/html.php';
            //require_once self::$parent_path  . '/includes/shortcodes.php';
        }
